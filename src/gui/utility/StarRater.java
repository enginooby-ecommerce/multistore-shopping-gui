...
public class StarRater extends JPanel {
  ...
  //private static final Image icon = ImageIO.read(new File("/images/emptyCart2.png"));
 

  /** The image. */
 // private static final Image STAR_BACKGROUND_IMAGE = SwingResourceManager.getImage(YourClass.class,"key-16x16.png");
  private static final Image i1 = compressedByteArrayToImage(new byte[] {
  ...
  Image STAR_BACKGROUND_IMAGE = i1.getScaledInstance(22, 22, Image.SCALE_SMOOTH);
  /** The image. */
  private static final Image i2 = compressedByteArrayToImage(new byte[] {
      (byte)0x1f, (byte)0x8b, (byte)0x08, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, 
  ...
  Image STAR_FOREGROUND_IMAGE = i2.getScaledInstance(22, 22, Image.SCALE_SMOOTH);
  /** The image. */
  private static final Image i3 = compressedByteArrayToImage(new byte[] {
      (byte)0x1f, (byte)0x8b, (byte)0x08, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, 
  ...
  Image STAR_ROLLOVER_IMAGE = i3.getScaledInstance(22, 22, Image.SCALE_SMOOTH);
  /** The image. */
  private static final Image i4 = compressedByteArrayToImage(new byte[] {
  ...
  Image  STAR_SELECTION_IMAGE = i4.getScaledInstance(22, 22, Image.SCALE_SMOOTH);
}
