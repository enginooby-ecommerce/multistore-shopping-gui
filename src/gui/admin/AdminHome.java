...
public class AdminHome extends JPanel {
	...
	public AdminHome() {
		...
		lblBestSeller.setBounds(39, 118, 200, 48);
		add(lblBestSeller);
		...
		List<Customer> list1 = Database.customer_list;
		String view[] = { "5", "10", "15" };
			...
			public void actionPerformed(ActionEvent evt) {
				...
				if (!list1.isEmpty()) {
					for (int i = list1.size() - 1; i > list1.size() - num - 1 && i > -1; i--) {
						...
						model.addRow(new Object[] { list1.get(i).getUsername(), list1.get(i).getPassword(),
								list1.get(i).getTimeCreated(), "Detail" });
		...
		JLabel lblPromotion = new JLabel("NEW RETAILERS");
		...
		JLabel lblNewestCustomers2 = new JLabel("newest retailers");
		...
		List<Retailer> list2 = Database.retailer_list;
		//String view[] = { "5", "10", "15" };
